<x-app-layout>
    <div class="grid grid-cols-12 md:grid--cols-2 gap-4 mb-4">
        <x-card
            class="col-span-12 md:col-span-4 xl:col-span-3 flex flex-col items-start py-8  border-t-4 border-t-primary-500">
        ...
        <x-card class="col-span-12 md:col-span-8 xl:col-span-9 p-0">
            <div class="border-b border-gray-200 dark:border-gray-700">
                <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="userProfileTab"
                    data-tabs-toggle="#userProfileTabContent" role="tablist">
                    <li class="mr-2" role="presentation">
                        <button class="inline-block p-3 border-b-2 rounded-t-lg" id="profile-tab"
            ...
            <div id="userProfileTabContent">
                <div class="hidden px-5 py-3" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                    Profile

                </div>

                <div class="hidden px-5 py-3" id="dashboard" role="tabpanel" aria-labelledby="dashboard-tab">
                    Dashboard
                </div>

                <div class="hidden px-5 py-3" id="settings" role="tabpanel" aria-labelledby="settings-tab">
                    Settings
                </div>
            </div>
